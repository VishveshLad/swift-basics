...
extension KeychainItem {
    ...
    static var identifier: String? {
        get {
            return try? KeychainItem(service: bundleIdentifier, account: "identifier").readItem()
        }
        set {
            guard let value = newValue else {
                try? KeychainItem(service: bundleIdentifier, account: "identifier").deleteItem()
                return
            }
            do {
                try KeychainItem(service: bundleIdentifier, account: "identifier").saveItem(value)
            } catch {
    ...
    static var deviceToken: String? {
        get {
            return try? KeychainItem(service: bundleIdentifier, account: "deviceToken").readItem()
        }
        set {
            guard let value = newValue else {
                try? KeychainItem(service: bundleIdentifier, account: "deviceToken").deleteItem()
                return
            }
            do {
                try KeychainItem(service: bundleIdentifier, account: "deviceToken").saveItem(value)
            } catch {
                print("Unable to save userEmail to keychain.")
            }
        }
